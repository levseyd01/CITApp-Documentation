...
function initCustomTippyPreviews() {
  ...
  // Add CSS for scrollable tooltips
  if (!document.getElementById('tippy-scroll-styles')) {
    const styleElement = document.createElement('style');
    styleElement.id = 'tippy-scroll-styles';
    styleElement.textContent = `
      .tippy-box[data-theme~='light-border'] {
        max-width: 550px !important;
      }
      .tippy-preview, .tippy-content {
        max-height: 450px;
        overflow-y: auto;
        overflow-x: hidden;
        scrollbar-width: thin;
      }
      .tippy-preview::-webkit-scrollbar, .tippy-content::-webkit-scrollbar {
        width: 8px;
      }
      .tippy-preview::-webkit-scrollbar-track, .tippy-content::-webkit-scrollbar-track {
        background: #f1f1f1;
      }
      .tippy-preview::-webkit-scrollbar-thumb, .tippy-content::-webkit-scrollbar-thumb {
        background: #888;
        border-radius: 4px;
      }
      .tippy-preview::-webkit-scrollbar-thumb:hover, .tippy-content::-webkit-scrollbar-thumb:hover {
        background: #555;
      }
      .tippy-full-content {
        width: 100%;
